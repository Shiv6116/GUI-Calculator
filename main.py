...
class Ui_Calculator(object):
    ...
    def setupUi(self, Calculator):
        ...
        self.AC.setStyleSheet("QPushButton {\n"
                              "    background-color: rgb(57, 97, 78);\n"
                              "    border-radius: 24px;                   \n"
                              "    color: rgb(0, 230, 255);   }\n"
                              "\n"
                              "QPushButton:hover {\n"
                              "    background: rgb(255, 52, 54);           /* Hover background color */\n"
                              "}")
        ...
        self.label.setGeometry(QtCore.QRect(0, 50, 271, 51))
    ...
    def retranslateUi(self, Calculator):
        ...
        Calculator.setWindowTitle(self._translate("Calculator", "GUI Calculator"))
